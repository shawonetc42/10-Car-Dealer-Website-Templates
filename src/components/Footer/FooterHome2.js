...
function Footer() {
  return (
    <div className="flex flex-col text-black mt-2">
      {/* Section 1 */}
      <div className="flex justify-center items-center border-b px-16 py-8 bg-indigo-50 max-md:px-5">
        <div className="flex gap-5 justify-between  w-full max-w-[1400px] max-md:flex-wrap max-md:max-w-full">
          ...
          <div className="flex gap-5 justify-end py-2.5 pr-2.5 pl-8 text-base bg-blue-600  bg-opacity-10 rounded-[60px] max-md:flex-wrap max-md:pl-5 max-md:max-w-full">
      ...
      {/* Section 2 */}
      <div className="flex justify-center items-start px-16 py-8 bg-indigo-50 leading-[185%] max-md:px-5">
        <div className="flex gap-5 justify-between w-full max-w-[1400px] max-md:flex-wrap max-md:max-w-full">
          {/* Column 1 */}
          ...
          <div className="flex flex-col text-base">
            ...
            <div className="flex gap-5 justify-between px-8 py-3.5 mt-8 rounded-2xl bg-blue-600  bg-opacity-10 max-md:px-5">
            ...
            <div className="flex gap-5 py-3.5 pr-12 pl-6 mt-3 rounded-2xl bg-blue-600 bg-opacity-10 max-md:px-5">
